...
import java.io.*;
// ssteward omit: import com.gitlab.pdftk_java.com.lowagie.text.ExceptionConverter;
...
public class PdfCopy extends PdfWriter {
    ...
    public PdfIndirectReference getParent(PdfDictionary annot) {
        PdfIndirectReference parent_ref= annot.getAsIndirectObject(PdfName.PARENT);
